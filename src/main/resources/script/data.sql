...
INSERT INTO `t_whitelist` (`id`, `create_by`, `update_by`, `create_time`, `update_time`, `deleted`, `version`, `remark`, `request_method`, `request_uri`, `description`, `status`) VALUES (1975094173811982337, NULL, NULL, now(), now(), 0, 1, NULL, 'GET', '/file/preview/**', '文件预览公开接口', '0');
